...
**Descrição:** [Descreva brevemente o propósito do sistema, suas principais funcionalidades e o publico-alvo.]
...
**Regras de negócio relevantes:** [Descreva aqui quaisquer regras especificas do negocio que impactam o comportamento esperado do sistema, ex: "Usuário Bloqueado após 3 tentativas de login", "Somente administradores podem excluir registros", etc. Se não houver, escreva "Não informado".]
